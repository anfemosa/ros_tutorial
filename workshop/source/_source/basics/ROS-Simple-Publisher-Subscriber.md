...
# Understanding ROS nodes with a simple Publisher - Subscriber pair
**Based on the [ROS 2 Tutorials](https://docs.ros.org/en/foxy/Tutorials/Writing-A-Simple-Py-Publisher-And-Subscriber.html)**

## Introduction

As we understood from the lectures, nodes are the fundamental units in ROS which are usually written to perform a specific task. They can be created in a few different ways such as- 
